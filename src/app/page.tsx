    ...
    <>
      <div className="w-full px-2   min-h-screen flex justify-center items-center bg-gradient-to-r from-rose-100 to-teal-100">
        <div className="flex flex-col">
            ...
            {status === 'authenticated' &&
              <div className="relative z-[100]">
                ...
                {showDropdown && (
                  <div
                    ref={dropdownRef}
                    className="bg-white  px-4 py-2 shadow-md cursor-pointer  absolute top-[50px] smallnavigation:left-[0px] left-[40px] rounded-lg w-[110px] text-center"
                    onClick={()=>{signOut()}}
                    >
          ...
          <p className="max-w-xl text-center mt-4 text-sm sm:text-lg text-slate-600 mb-6 pt-4">
